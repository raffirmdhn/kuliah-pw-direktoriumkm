...
$provinsi_list = $provinsi->index(); // Assuming this method fetches all provinces
    ...
    <div class="card">
      ...
      <div class="card-body">
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="nama" name="nama" value="<?= getSafeFormValue($show_kabkota, 'nama') ?>" placeholder="cth: Bandung" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="latitude" name="latitude" value="<?= getSafeFormValue($show_kabkota, 'latitude') ?>" placeholder="cth: -6.917464" required>
        </div>
        <div class="form-group">
          <label for="longitude">Longitude</label>
          <input type="text" class="form-control" id="longitude" name="longitude" value="<?= getSafeFormValue($show_kabkota, 'longitude') ?>" placeholder="cth: 107.619123" required>
        </div>
      </div>
