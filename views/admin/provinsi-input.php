    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="latitude" name="latitude" value="<?= getSafeFormValue($show_provinsi, 'latitude') ?>" placeholder="cth: -6.914744" required>
        </div>
        <div class="form-group">
          <label for="longitude">Longitude</label>
          <input type="text" class="form-control" id="longitude" name="longitude" value="<?= getSafeFormValue($show_provinsi, 'longitude') ?>" placeholder="cth: -8.762582" required>
        </div>
      </div>
